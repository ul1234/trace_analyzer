...
TRACES_CONFIG = {
    ...
    'PDSCH BRP': [(30, 'Pdsch Copro', [(('NR_L0_PDSCHBRP_COPRO_START', 'NR_L0_PDSCHBRP_COPRO_END'), 'b', {'combine_core': True, 'show': False})]),
                  (31, 'Pdsch Copro Req', [(('NR_L0_PDSCHBRP_COPRO_REQ_START', 'NR_L0_PDSCHBRP_COPRO_REQ_END'), 'g', {'combine_core': True, 'rand_core_color': True})]),
                  (32, 'Pdsch Copro Cnf', [(('NR_L0_PDSCHBRP_COPRO_CNF_START', 'NR_L0_PDSCHBRP_COPRO_CNF_END'), 'r', {'show': True})]),
                  (33, 'Pdsch Post', [(('NR_L0_PDSCHBRP_POST_PROCESS_START', 'NR_L0_PDSCHBRP_POST_PROCESS_END'), 'm', {'combine_core': True}),
    ...
    'UL BRP':  [(50, 'PUSCH ENCODE', [(('NR_L0_ULBRP_UCP_REQ_MSG_SENT','NR_L0_ULBRP_UCP_RSP_MSG_RECEIVED'), 'm', {'same_core': False}),
